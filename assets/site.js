(function () {
  ...
  async function loadWalletDashboard() {
    ...
    try {
      ...
      ownedEl.textContent = ownedTokens ? ownedTokens.length : 0;
      stakedEl.textContent = stakedTokens ? stakedTokens.length : 0;
      rewardsEarnedEl.textContent = formatFlyzValue(stakerSnapshot ? stakerSnapshot.unclaimedRewards : null);
      rewardsAvailableEl.textContent = formatFlyzValue(typeof rewardsAvailable === 'number' ? rewardsAvailable : null);
