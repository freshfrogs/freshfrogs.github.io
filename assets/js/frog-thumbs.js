...
// Use buildFrog128 to render layered thumbnails ONLY in the Dashboard (owned/staked).
// Keeps original flat image as shifted background.

(function(){
  'use strict';

  // ----- where to apply (dashboard only) -----
  var ROOTS = ['#ownedPanel','#dashboardPanel','.owned-panel','.wallet-owned','.cards-owned','.owned-grid','.owned-cards','.dashboard-owned'];
  ...
  // ---- original build function (uses 128px + shifted bg) ----
  ...
  // ---- upgrade only dashboard thumbnails ----
