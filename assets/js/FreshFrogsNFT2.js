  ...
  async function fetch_user_data(fetch_address) {
    ...
    if (user_tokens >= 1 || staker_tokens >= 1) {
      ...
      if (render_vault) {
        ...
        Output(
          '<button onclick="claimRewards_init()" style="list-style: none; min-height: 40px; padding: 8px; border-radius: 5px; border: 1px solid black; width: 50%; box-shadow: 3px 3px rgb(122 122 122 / 20%); margin: 16px; margin-left: auto; margin-right: auto; line-height: 1; text-align: center; vertical-align: middle;" class="frog_button">'+
          ...
          '</button>'+'<br>'+
          '<button onclick="claimRewards_init()" style="list-style: none; min-height: 40px; padding: 8px; border-radius: 5px; border: 1px solid black; width: 50%; box-shadow: 3px 3px rgb(122 122 122 / 20%); margin: 16px; margin-left: auto; margin-right: auto; line-height: 1; text-align: center; vertical-align: middle;" class="frog_button">'+
            '<strong>Staking Vault</strong><br>'+'View Community Staked Frogs'+
          '</button>'+'<br>'+
