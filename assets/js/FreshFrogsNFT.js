  ...
  async function render_token(frog_id, recent_sale) {
    ...
    if (!staked) { // NOT Staked
      ...
      '<b id="progress_'+frog_id+'">'+'<div style="color:tomato;" class="frog_level">Staked Lvl '+staked_level+'</div>'+'</b><div class="myProgress" id="myProgress_'+frog_id+'"><div class="myBar" id="myBar_'+frog_id+'"></div></div>';
  ...
  async function morphFrogs(baseId, subId, build_loc) {
    ...
    // Sub Adaptative Frog
    else if (subFrog == 'splendidLeafFrog' || subFrog == 'stawberryDartFrog' || subFrog == 'redEyedTreeFrog') { renderOverlay = subFrog+'/'+baseTrait; }
