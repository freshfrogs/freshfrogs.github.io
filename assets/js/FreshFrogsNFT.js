  ...
  async function render_token(frog_id, recent_sale) {
    ...
    if (!staked) {
      ...
      button_b.innerHTML = 
        '<br>'+
        '<button class="frog_button" style="background: lightgreen; border: 1px solid black;" onclick="stake('+frog_id+', '+user_address+')">Stake 🡥</button>'+
      ...
      // Or Un-stake Button
      button_b.innerHTML = '<br><button class="frog_button" style="background: coral; border: 1px solid black;" onclick="withdraw('+frog_id+', '+user_address+')">UnStake 🡥</button> <a style="margin: 0px !important; width: fit-content; height: auto; display: initial;" href="'+frog_gemxyz+'" target="_blank"><button class="frog_button">Rankings 🡥</button></a>';
      document.getElementById('traits_'+frog_id).appendChild(button_b);
