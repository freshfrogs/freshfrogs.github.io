  ...
  async function render_token(frog_id, recent_sale) {
    ...
    for (let i = 0; i < metadata.attributes.length; i++) {
      ...
      if (attribute.trait_type == 'Frog' || attribute.trait_type == 'SpecialFrog') { trait_text.innerHTML = attribute.trait_type+': <br><frog id="frogType_'+frog_id+'">'+attribute.value+'</frog> <b class="trait" style="font-size: smaller;"><i>('+trait_rarity+')</i></b><br><br>'; }
      else { trait_text.innerHTML = attribute.trait_type+': <br>'+attribute.value+' <b class="trait" style="font-size: smaller;"><i>('+trait_rarity+')</i></b><br><br>'; }
