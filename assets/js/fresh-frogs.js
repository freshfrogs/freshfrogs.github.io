...
async function connect() {
  ...
  function fetch_user_tokens(offset) {
    ...
    fetch('https://eth-mainnet.g.alchemy.com/nft/v3/C71cZZLIIjuEeWwP4s8zut6O3OGJGyoJ/getNFTsForOwner?owner='+user_address+'&contractAddresses[]=0xBE4Bef8735107db540De269FF82c7dE9ef68C51b&withMetadata=false&pageSize=100')
  ...
  function load_trait(trait, attribute, where) {
    ...
    //  newAttribute.src = "/pond/"+trait+"/"+attribute+".gif"
    } else if (attribute === "cyan_tongueFly") { 
      newAttribute.src = "/pond/"+trait+"/"+attribute+".gif"
    } else if (attribute === "morphAnimation") {
      newAttribute.src = "/pond/Frog/loadMorph.gif"
    } else if (attribute === "shadesAnimation") {
      newAttribute.src = "/pond/Eyes/shadesAnimation.gif"
  ...
  async function fetch_staked_frogs() {
    ...
    fetch('https://eth-mainnet.g.alchemy.com/nft/v3/C71cZZLIIjuEeWwP4s8zut6O3OGJGyoJ/getNFTsForOwner?owner=0xCB1ee125CFf4051a10a55a09B10613876C4Ef199&contractAddresses[]=0xBE4Bef8735107db540De269FF82c7dE9ef68C51b&withMetadata=false&pageSize=100')
    .then((tokens) => tokens.json())
    .then((tokens) => {
