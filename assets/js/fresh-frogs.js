...
async function connect() {
  ...
  async function claim_rewards() {
    ...
    try {
      ...
      consoleOutput('Transaction Failed<br><br><p>'+e.message+'</p><a href="https://discord.gg/xWMFWgpvd3" target="_blank" class="pointer"><strong><u>Discord #Support</u></strong></a>');
  ...
  async function stake(token_id) {
    ...
    try {
      ...
      consoleOutput('<img src="https://freshfrogs.io/frog/'+token_id+'.png" class="recentMint"/><br><strong>Staking Frog #'+token_id+'...</strong><br>Transaction Failed<br>'+'<br><p>'+e.message+'</p><a href="https://discord.gg/xWMFWgpvd3" target="_blank" class="pointer"><strong><u>Discord #Support</u></strong></a>');
  ...
  async function withdraw(token_id) {
    ...
    try {
      ...
      consoleOutput('<img src="https://freshfrogs.io/frog/'+token_id+'.png" class="recentMint"/><br><strong>Withdrawing Frog #'+token_id+'...</strong><br>Transaction Failed<br>'+'<br><p>'+e.message+'</p><a href="https://discord.gg/xWMFWgpvd3" target="_blank" class="pointer"><strong><u>Discord #Support</u></strong></a>');
  ...
  async function render_token(token_id, staked, cost) {
    ...
    try {
      ...
      frog_token.innerHTML = '<div class="frogTokenCont"><div style="text-align: left; margin: 8px;"><strong id="frog_'+token_id+'" class="frog_name"></strong><strong id="price_'+token_id+'" class="frog_price"></strong></div><img src="'+external_link+'" class="frog_img"/><div id="traits_'+token_id+'" class="trait_list"></div></div>';
      ...
      */
      ...
      if (staked) {
        ...
        button_b.innerHTML = '<br><button class="frog_button" style="background: lightgreen; border: 1px solid black;" onclick="stake('+token_id+')">Stake 🡥</button> <a style="margin: 0px !important; width: fit-content; height: auto; display: initial;" href="'+gemxyzLink+'" target="_blank"><button class="frog_button">Rankings 🡥</button></a>'
      }
