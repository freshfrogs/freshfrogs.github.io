...
async function connect() {
  ...
  async function render_token(token_id, staked, cost) {
    ...
    try {
      ...
      frog_token.innerHTML = '<div class="frogTokenCont"><img src="'+external_link+'" class="recentMint" style="width: 256px !important; height: 256px !important;"/><div id="traits_'+token_id+'" class="trait_list"></div></div>';
