    ...
    const COLLECTION_ABI = require("./assets/fresh-frogs/collection.json");
    const CONTROLLER_ABI = require("./assets/fresh-frogs/controller.json");
    ...
    async function withdraw(tokenId_r) {
        ...
        // Valid ownership
            ...
            try {
                ...
                controller.methods.withdraw(tokenId).send({from: user_address})
