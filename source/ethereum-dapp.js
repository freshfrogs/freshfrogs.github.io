...
async function render_recently_sold(token_data) {
    ...
    top_right = 
        '<div style="margin: 8px; float: right; width: 100px;">'+
            ...
            '<text id="frog_type" style="color: teal;">Ξ'+toFixedPoint(sale_price, 3)+' ($'+sale_price_usd+')</text>'+
        '</div>'
    bottom_left = 
        '<div style="margin: 8px; float: right; width: 100px;">'+
