...
async function update_frontend() {
    ...
    stakeContainer_element.innerHTML = 
        ...
        '</p>'+
        '<button id="stakeButton" class="connectButton" onclick="await initiate_setApprovalForAll(); "style="color: white; background: lightsalmon; margin-top: 10px;">🌱 Stake & Earn!</button>';
        //'<p class="paragraph_container">Staked Tokens: ('+user_stakedBalance+') | Rewards: '+user_rewards.toFixed(2)+' $FLYZ</p>';
