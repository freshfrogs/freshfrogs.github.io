...
←----{ To mint a FROG, link your wallet and then click the '*<b>MINT</b> (transact)*' button below the available mint. A total supply of *4,040* FROGs will be available starting at 0.04 ΞEth (+ gas fees). Invite codes will automatically applied during mint.
