...
←----{ To mint a FROG, first link your crypto wallet and then simply click the '*<b>MINT</b> (transact)*' button below the available mint. A total supply of 4,040 FROGs will be available for 0.04 ΞEth + gas fees. Invite codes will automatically applied during mint.
