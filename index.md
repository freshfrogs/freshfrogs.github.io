...
←----{ To mint a FROG, link your wallet and then click '*<b>MINT</b> (transact)*'. A total supply of *4,040* FROGs will be available starting at 0.04 ΞEth (+ gas fees). Invite codes will automatically be applied during mint.
