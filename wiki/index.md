...
<div class="float-img2">
    ...
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Trait/trait.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Accessory/accessory.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Eyes/eyes_gif.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Hat/hat.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Mouth/mouth.gif"/>
</div>
