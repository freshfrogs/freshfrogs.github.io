...
<div class="float-img2">
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Frog/frog_gif.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Trait/trait_gif.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Accessory/accessory_gif.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Eyes/eyes_gif.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Hat/hat_gif.gif"/>
    <img class="frogImg2" style="padding: 64px" src="../the-pad/Mouth/mouth_gif.gif"/>
</div>
