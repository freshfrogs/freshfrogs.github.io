...
<div class="minting-display">
    <div>
        <div id="mintingTray" class="mintingTray">
            <a id="display-frogLink" href="https://opensea.io/collection/fresh-frogs" target="_blank">
                ...
                <div id="display-table">
                    ...
                    <b id="frog_name" class="frog_name">0.01 ΞETH</b><b id="frog_price" class="frog_price">--</b>
                </div>
            </a>
        </div>
